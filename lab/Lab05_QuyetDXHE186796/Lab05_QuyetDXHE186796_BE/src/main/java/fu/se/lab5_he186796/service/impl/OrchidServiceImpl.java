package fu.se.lab5_he186796.service.impl;

import fu.se.lab5_he186796.dto.request.OrchidRequest;
import fu.se.lab5_he186796.dto.response.OrchidResponse;
import fu.se.lab5_he186796.entity.Orchid;
import fu.se.lab5_he186796.exception.AppException;
import fu.se.lab5_he186796.exception.ErrorCode;
import fu.se.lab5_he186796.repository.OrchidRepository;
...
public class OrchidServiceImpl implements OrchidService {
    ...
    private OrchidResponse mapToResponse(Orchid orchid) {
        return OrchidResponse.builder()
                ...
                .attractive(orchid.isAttractive())

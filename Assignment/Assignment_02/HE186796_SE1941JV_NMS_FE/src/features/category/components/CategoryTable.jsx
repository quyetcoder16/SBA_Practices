                    ...
                    {data.map((item) => (
                        <tr key={item.categoryId}>
                            ...
                            <td className="text-muted" style={{ maxWidth: '250px' }}>
                                <div className="text-truncate">{item.categoryDesciption || '---'}</div>
                            </td>
                            <td className="text-muted">
                                {item.parentCategoryName
                                    ? <Badge bg="secondary" className="fw-normal">{item.parentCategoryName}</Badge>
                                    : <span className="text-muted fst-italic">Top Level</span>
                                }
                            </td>
                            <td>
                                {item.isActive ? (
